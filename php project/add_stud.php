           ...
           <div id="section">
                ...
                <div class="lbox">
                    ...
                    <?php
                        ...
                        if($res->num_rows>0)
                        {
                            $rowl=$res->fetch_assoc();
                            $no=substr($rowl["RNO"],1,strlen($row1["RNO"]));
                            $no="S".$no;
                        }
                    ?>
                    <input type="text" class="input3" name="rno" style="background:#b1b1b1;"value="<?php
                    echo $no;?>" readonly><br><br>
                    <lable>Student Name</lable><br>
                    <input type="text" class="input3" name="name" ><br><br>
                    <lable>Father Name</lable><br>
                    <input type="text" class="input3" name="fname" ><br><br>
                    
                    <label>Date of Birth</lable><br>
                    <select name="da" required class="input5">
                   ...
                   <select name="mo" required class="input5">
                    ...
                    <select name="ye" required class="input5">
                   ...
                   <select name="gen" required class="input3">
                    ...
                    <input type="text" class="input3" maxlength="10" name="pno"><br><br>
                    </div>
                    
                    <div class="rbox">
                    <label>Parent's Mail Id</lable>
                    <input type="text" class="input3" name="email"><br><br> 
                    <label>Address</lable>
