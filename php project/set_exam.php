<?php
    ...
    {
        echo "<script>window.open('set_exam.php?mes=Access Denied..','_self');</script>";
    }
?>
<!DOCTYPE html>
<html>
            ...
            <div class="content">
                    ...
                    <?php
                       ...
                       { 
                          ...
                          $sq="insert into exam(ENAME,ETYPE,EDATE,SESSION,CLASS,SUB) values('{$_POST["eame"]}','{$_POST["etype"]}','{$_POST["edate"]}','{$_POST["ses"]}','{$_POST["cla"]}','{$_POST["sub"]}')";
                          if($db->query($sq))
                          {
                            if($db->query($sq))
                          { 
                   ...
                   <select name="ses" required class="input3">
                    ...
                    <?php
                          ...
                          if($r->num_rows>0)
                          {
                              ...
                              while($ro=$r->fetch_assoc())
                              {
                                  echo"<option vlaue='{$ro["SNAME"]}'>{$ro["SNAME"]}</option>";
                              }
                          }
                      ?>
