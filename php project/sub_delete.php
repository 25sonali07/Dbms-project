<?php
    ...
    session_start();
    if(!isset($_SERVER["SID"]))
    {
        echo "<script>window.open('sub_delete.php?mes=Access Denied..','_self');</script>";
    }
        ...
        <div id="section">
           ...
           <div class="content1">
            ...
            <form method="post"  action="<?php echo $_SERVER["PHP_SELF"];?>">
               ...
               <button type="submit" class="btn" name="submit">Add Submit Details</button>
            </form>
