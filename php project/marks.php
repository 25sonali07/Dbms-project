           ...
           <div id="section">
                ...
                <div class="content">
                          ...
                          <?php
                            ...
                            {
                               $sq="insert into mark(REGNO,MARK,TERM,CLASS) values('{$_POST["regno"]}','{$_POST["sub"]}','{$_POST["mark"]}','{$_POST["etype"]}','{$_POST["class"]}')";
                               if($db->query($sq))
                               {
                  ...
                  <form method="post"  action="<?php echo $_SERVER["REQUEST_URL"]; ?>">
                    ...
                    <input type="text" style="background:#b1b1b1;"value="<?php echo $regno;?>" class="input3" name="regno"><br><br>
  
                    <label>Class</label><br>
                    <input type="text" style="background:#b1b1b1;" value="<?php echo $class;?>" class="input3" name="class"><br><br>
